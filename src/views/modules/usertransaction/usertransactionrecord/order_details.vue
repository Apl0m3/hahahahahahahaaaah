<template>
  <el-dialog
    ...
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item :title="$t('manage.trRecord.orderDetails.title2')" name="1">
        <el-form ref="dataForm" label-width="130px">
          ...
          <el-form-item label="供应商发货运单号" v-if="transaction.deliveryLogistics" prop="deliveryLogistics">
            {{transaction.deliveryLogistics}}
          </el-form-item>
          <el-form-item label="用户退换货运单号" v-if="transaction.userReturnLogistics" prop="userReturnLogistics">
            {{transaction.userReturnLogistics}}
          </el-form-item>
          <el-form-item label="供应商换货运单号" v-if="transaction.exchangeLogistics"  prop="exchangeLogistics">
            {{transaction.exchangeLogistics}}
          </el-form-item>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <img :src="global.showUrl+scope.row.image" width="100px" height="100px">
            </template>
          </el-table-column>
          <el-table-column
            prop="name"
            :label="$t('manage.trRecord.orderDetails.name')"
            width="180">
          </el-table-column>
          <el-table-column
            prop="size"
    ...
    <delivery v-if="deliveryShow" ref="deliveryRef"></delivery>
  </el-dialog>
